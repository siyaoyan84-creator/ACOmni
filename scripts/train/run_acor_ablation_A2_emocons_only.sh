...
# ACOR Reward Ablation A2 - Format + Accuracy + Emotion Consistency from SFT checkpoint-2264
# Purpose: Keep emotion_consistency reward while disabling affective_context reward
# Start checkpoint: SFT checkpoint-2264
# Reward funcs: format,accuracy,emotion_consistency

set -e

echo "=========================================="
echo "ACOR Reward Ablation A2 - Format + Accuracy + Emotion Consistency"
echo "Start checkpoint: SFT checkpoint-2264"
echo "Reward funcs: format,accuracy,emotion_consistency"
echo "Affective context reward disabled"
echo "=========================================="
...
# ========== Reward Configuration - A2 ==========
export GRPO_REWARD_FUNCS="format,accuracy,emotion_consistency"

# ========== Affective/Emotion Rewards Weights ==========
export GRPO_AFFECTIVE_CONTEXT_REWARD_WEIGHT=0.0
...
# ========== Output Directory ==========
export OUTPUT_DIR="${OUTPUT_ROOT}/acor_reward_ablation_A2_consistency_only_sft2264_500"
...
torchrun --nproc_per_node $NPROC_PER_NODE --nnodes=$NNODES --node_rank=$NODE_RANK --master_addr=$MASTER_ADDR --master_port=$MASTER_PORT \
    ...
    --num_train_epochs 1 \
    --run_name acor_reward_ablation_A2_consistency_only_sft2264_500 \
